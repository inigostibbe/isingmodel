...
# Ensure L is divisible by size
assert L % size == 0, "Lattice size must be divisible by the number of processes."

local_L = L // size  # Number of rows per process
...
comm.Gather(local_lattice.flatten(), gathered_lattice, root=0)
